  ...
  try:
    ...
    def classify(pose) :
               ...
               with tf.compat.v1.Session() as sess:
                   new_saver_toss = tf.compat.v1.train.import_meta_graph('lstm/tossFinalog1/toss_18_multiplayer.ckpt.meta')
                   new_saver_toss.restore(sess,'lstm/tossFinalog1/toss_18_multiplayer.ckpt')
