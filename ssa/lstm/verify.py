...
DATASET_PATH = "volleyball/toss_final_round1/"
...
with tf.compat.v1.Session() as sess:
    new_saver = tf.compat.v1.train.import_meta_graph('tossFinalog1/toss_18_multiplayer.ckpt.meta')#log/123model.ckpt.meta
    new_saver.restore(sess,'tossFinalog1/toss_18_multiplayer.ckpt')#log/123model.ckpt
