    ...
    while(True):
           ...
           if len(pose) == 18:
               ...
               with tf.compat.v1.Session() as sess:
                   new_saver = tf.compat.v1.train.import_meta_graph('lstm/tosslog2/toss_18_multiplayer.ckpt.meta')
                   new_saver.restore(sess,'lstm/tosslog2/toss_18_multiplayer.ckpt')
