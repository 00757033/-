# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 23:59:11 2021
...
PostureComparison = tk.Button(window, text='姿勢比對',width=10,height=3,font=("Times", 30),command=GUI_st.total_init)
PostureComparison.grid(column=1, row=1)
immediate = tk.Button(window, text='自我練習',width=10,height=3,font=("Times", 30),command=GUI_st.total_init)
